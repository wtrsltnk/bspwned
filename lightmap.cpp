...
void CalcSurfaceExtents(const tBSPFace& bspFace, const tBSPTexInfo& texinfo, int* surfedges, const tBSPEdge* edges, const tBSPVertex* vertices, float min[2], float max[2])
{
